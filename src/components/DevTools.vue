...
const clearAllData = () => {
  if (confirm('Are you sure you want to clear all stored data? This will remove all favorites and reset preferences.')) {
      ...
      <div v-if="isExpanded" 
        ...
        <div class="space-y-2">
          ...
          <div class="flex gap-2">
            <button
              @click="clearAllData"
              class="px-3 py-1.5 bg-red-600 text-white text-sm rounded
            ...
            <button
              @click="clearCache"
              class="px-3 py-1.5 bg-orange-500 text-white text-sm rounded
